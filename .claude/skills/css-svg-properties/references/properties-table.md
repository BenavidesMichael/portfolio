...
| `glyph-orientation-horizontal` | Text content elements *(deprecated in SVG 2)* |
| `glyph-orientation-vertical` | Text content elements |
| `kerning` | Text content elements *(deprecated in SVG 2)* |
...
| `enable-background` | Container elements *(deprecated in SVG 2)* |
...
*(CSS-animatable coordinates and dimensions)*
